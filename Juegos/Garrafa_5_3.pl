...
% 5. Vaciar contenid garrafa de 5 en 3
% 6. Vaciar contenid garrafa de 3 en 5
...
% 5.1. Vaciar contenid garrafa de 5 en 3
...
% 6.1. Vaciar contenid garrafa de 3 en 5
...
% para ir deswde el EstadoIni hasta EstadoFin sin repetir en la
